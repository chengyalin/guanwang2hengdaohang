...
<style scoped>
    ...
    .codeFour{margin-top: 20px;background:rgba(246,246,246,1);width: 100%; height: 88px;position: absolute;left: 0;bottom: 0;}
    .codeFour .vistUs{font-size: 14px;color: rgba(68,68,68,1);line-height: 88px;margin: 0 210px 0 60px;float: left;}
    .codeFour .codeOne{display: block;width:36px;height: 36px;line-height: 36px;text-align: center; background-color: #B4B4B4;float: left;position: relative;margin-right: 10px;cursor: pointer;margin-top: 26px;}
    .codeFour .codeOne:hover{background-color: #3ED8C4;}
    .codeFour .codeOne .codeIcon{display: block;}
    .codeFour .codeOne .codeDown{display: none;position: absolute;left: -88px;top:-122px;}
    .codeFour .codeOne .codeDown .codeImg{ddisplay: block; width: 211px;height:113px;margin: 0 auto;}
    .codeFour .codeOne:hover .codeDown{display: block;}
    .imgLinkIcon{display: block;width: 36px;height: 36px;}
