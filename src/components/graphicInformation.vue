    ...
    <div class="graphicInformation"  @click="open=false" v-title data-title="图文资讯">
        ...
        <div class="topBanner">
            ...
            <div class="bannerAreaMain">
                ...
                <img src="https://resource.tanwuapp.com/lpVjPL0S6K_VtFhqHZaYNscqlfIM">
            </div>
        </div>
                    ...
                    <li  v-for="(item,index) in themesByLabelList" :key = "(item,index)">
                        <router-link :to="{path:'/dynamic/graphicInformationDetail',query:{themeId:item.themeId}}"  tag="a" target="_blank">
                            <div class="graphicItem">
                                <div class="left" :style="{'background-image':'url('+item.themeImage+')'}"></div>
                                <div class="right">
...
<style scoped>
    ...
    .graphicList ul li .graphicItem .left{width: 630px;height: 320px;float: left;background-size: cover; background-position: 50%;}
