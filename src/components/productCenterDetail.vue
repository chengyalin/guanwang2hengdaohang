<template>
    <div class="productCenterDetail" v-title data-title="产品详情" v-show="showDetail">
        ...
        <div class="labelBarDetail"><router-link to="/indexPage">首页 ></router-link> <router-link to="/product"> 产品中心 ></router-link> <span>产品详情页</span></div>

        <div class="proCenterDetailMain">
            <div class="topInfoArea">
                <div class="left" >
                    <!-- Swiper -->
                    <swiper :options="swiperOptionDetail" ref="mySwiper" v-if="mainData.products.image_list_src.length>0">
            ...
            <div class="DetailInfoArea">
                <div class="tabName">
                    <a @click="tabChange(index)"  v-for="(item,index) in tabArray" :key="index" class="tabNameOne" :class="{'active': isActive === index}">
                        ...
                        <img src="static/img/procenterDetail3.png" alt="" class="tringle" v-show="index">
                    </a>
                </div>
        ...
        methods:{
            ...
            getProductDetail(){
                ...
                network(CONFIG.product, {
                    ...
                    that.mainData.products.image_list_src = res.details.products.image_list_src.split(",") || res.details.products.image_list_src;
...
<style scoped>
    /*详情*/
    .productCenterDetail{background-color: #F6F6F6;}
    ...
    .topInfoArea .left /deep/ .swiper-button-prev{left: 0px;top: 45%;background-color: rgba(62,216,196,1);width: 60px;height: 60px;background-image:url("../../static/img/swiper-left.png");background-size: cover;}
    .topInfoArea .left /deep/ .swiper-button-next{right: 0px;top: 45%;background-color: rgba(62,216,196,1);width: 60px;height: 60px;background-image:url("../../static/img/swiper-right.png");background-size: cover;}
    .topInfoArea .left /deep/ .swiper-pagination.swiper-pagination-bullets{bottom: 15px;}
    .topInfoArea .left /deep/ .swiper-pagination-bullet {width: 4px;height: 4px;display: inline-block;/*border-radius: unset;*/background: #000;margin: 0 8px;bottom: 0;}
    .topInfoArea .left /deep/ .swiper-pagination-bullet.swiper-pagination-bullet-active{background-color: #3ED8C4;height: 4px; width: 40px;border-radius: unset;}
    /*鼠标移入hover左右滚动按钮变色*/
    .topInfoArea .left/deep/ .swiper-button-prev:hover,
    .topInfoArea .left/deep/ .swiper-button-next:hover {background-color: #38cdba;}

    .topInfoArea .right{width: 480px;float: right;padding-right: 90px;}
    .topInfoArea .right .title{font-size: 26px;color:rgba(34,34,34,1);height: 36px;line-height: 36px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;margin-bottom: 4px;margin-top: 40px;}

    .topInfoArea .right .starArea{color: #999999;font-size: 14px;}
    .topInfoArea .right .starArea  .grayStar{background:url(../../static/img/star-gray.png) repeat-x 0 0;width:81px;height:13px;position: relative;display: inline-block;vertical-align: middle;}
    .topInfoArea .right .starArea  .yellowStar{background:url(../../static/img/star-yellow.png) repeat-x 0 0;height:13px;position: absolute;top:0;left: 0;}
    ...
    .conditionArea{border-top: 1px solid rgba(180,180,180,1);border-bottom: 1px solid rgba(180,180,180,1);padding: 10px 0; position: relative;margin-top: 20px;}
    ...
    .ticketShowArea{width: 210px;height: 96px;border: 1px solid #EEEEEE;position: absolute;top:70px;left: 0;display: none;background-color: #fff;    -webkit-box-shadow: 0 0 8px #e2e2e2;box-shadow: 0 0 8px #e2e2e2;}
    .ticketShowArea .ticketLeft{display: block;width: 83px;height: 83px;float: left;margin: 7px;overflow: hidden; }
    ...
    .rulesQuestion .answer{font-size: 14px;color:rgba(102,102,102,1);padding-left: 40px;margin-top: 18px;margin-bottom: 45px;}

    /*产品口碑*/
    .productMouth{padding: 0 40px 100px;}
    .productMouth ul{}
    .productMouth ul li{padding-bottom: 20px;}
    ...
    .proMouthOne .praise{position: absolute;top:0px;right: 0px;font-size: 14px;color:rgba(136,136,136,1);text-align: right;padding-left: 30px;background: url("../../static/img/proMouthZAN.png") no-repeat 0;cursor: pointer;}
    ...
    .proMouthOne  .wordInfo{font-size: 14px;color:rgba(34,34,34,1);margin: 14px 0 20px;line-height: 28px;}
    ...
    .MouthTabContent .bigItem{max-width: 100%;}
