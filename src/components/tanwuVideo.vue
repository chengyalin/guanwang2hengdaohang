  ...
  <div class="tanwuVideo" @click="open=false"  v-title data-title="探物视频">
      ...
      <div class="topBanner">
          ...
          <div class="bannerAreaMain">
              ...
              <img src="https://resource.tanwuapp.com/lu-5RryMKqwHqf2q_5JCSP5P_-dJ">
          </div>
      </div>
          ...
          <div class="tanwuVideoList">
            <ul>
                ...
                <li  v-for = "(item,index) in listData" :key = "index">
                    <router-link :to="{path:'/dynamic/tanwuVideoDetail',query:{videoId:item.videoId}}"  tag="a" target="_blank">
