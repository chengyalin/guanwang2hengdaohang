<template>
  <div class="graphicInformationDetail"  v-title data-title="图文资讯详情">
      ...
      <div class="labelBarDetailZX"><router-link to="/indexPage">首页 ></router-link><router-link to="/dynamic">资讯动态 ></router-link><router-link to="/dynamic/graphicInformation">  图文资讯 ></router-link> <span>图文资讯详情页</span></div>
      ...
      <div class="graphicInformationDetailArea">
          ...
          <div class="graphicInformationDetailMain">
              <p>{{graphicInformationDetailList.themeDesc}}</p>
...
.graphicInfMain{width: 100%; height: 520px;background-size: cover; background-position: 50%;position: relative;}
