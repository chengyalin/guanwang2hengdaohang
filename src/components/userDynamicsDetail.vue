<template>
    <div class="userDynamicsDetail"  v-title data-title="用户动态详情">
        ...
        <div class="labelBarDetailZX"><router-link to="/indexPage">首页 ></router-link><router-link to="/dynamic">资讯动态 ></router-link><router-link to="/dynamic/userDynamics">  用户动态 > </router-link><span>用户动态详情页</span></div>
        ...
        <div class="userDynamicsDetailArea">
            <div class="DynamicsDetailAreaMain">
                ...
                <div class="introWordMain">
                    ...
                    <div class="scrollAreaDetail">
                        <!-- Swiper -->
                        <swiper :options="swiperOptionDetail" ref="mySwiper" v-if="DynamicsDetailListImg.length>0">
                            <div class="swiper-slide" v-for="item in DynamicsDetailListImg">
                                <img  :src="item" alt="">
                            </div>
                            <!-- Add Pagination -->
...
<style scoped>
    ...
    .scrollAreaDetail{height: 660px;position: relative;max-height: 660px;overflow: hidden;    margin-bottom: 60px;}
    .scrollAreaDetail /deep/ .swiper-button-prev{left: 0px;top: 300px;background-color: rgba(62,216,196,1);width: 60px;height: 60px;background-image:url("../../static/img/swiper-left.png");background-size: cover;}
    .scrollAreaDetail /deep/ .swiper-button-next{right: 0px;top:300px;background-color: rgba(62,216,196,1);width: 60px;height: 60px;background-image:url("../../static/img/swiper-right.png");background-size: cover;}
    .scrollAreaDetail img{display: block;max-width: 940px; height: 660px;margin: 0 auto;}
