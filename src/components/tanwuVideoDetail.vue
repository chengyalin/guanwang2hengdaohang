<template>
  <div class="tanwuVideoDetail"  v-title data-title="视频详情">
      ...
      <div class="labelBarDetailVideo"><router-link to="/indexPage">首页 ></router-link><router-link to="/dynamic">资讯动态 ></router-link> <router-link to="/dynamic/tanwuVideo"> 探物视频 > </router-link><span>探物视频详情页</span></div>
