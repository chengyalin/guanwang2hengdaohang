...
import product from '@/components/product'//产品中心空
...
import dynamic from '@/components/dynamic'//资讯动态
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
          ...
          {
              path: '/product/productCenterDetail',
...

    {
        ...
        component: dynamic,
        meta: { title: '资讯动态' },
        redirect:'/dynamic/userDynamics',
        children:[
            {
                path: '/dynamic/userDynamics',
                component: userDynamics,
                meta: { title: '用户动态' }
            },
            {
                path: '/dynamic/userDynamicsDetail',
                component: userDynamicsDetail,
                meta: { title: '用户动态详情' }
            },
            {
                path: '/dynamic/graphicInformation',
                component: graphicInformation,
                meta: { title: '图文资讯' }
            },
            {
                path: '/dynamic/graphicInformationDetail',
                component: graphicInformationDetail,
                meta: { title: '图文咨询详情' }
            },
            {
                path: '/dynamic/tanwuVideo',
                component: tanwuVideo,
                meta: { title: '探物视频' }
            },
            {
                path: '/dynamic/tanwuVideoDetail',
